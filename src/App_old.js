    ...
    <>
      ...
      <div className="container">
        ...
        <div style={{ display: 'flex', gap: '20px', alignItems: 'center', marginBottom: '30px' }}>
          ...
          <Button onClick={() => handleSort('totalClicks')} variant="secondary">
        ...
        <div style={{ maxWidth: '300px', marginBottom: '20px' }}>
            <Input
                ...
                placeholder="Start typing a channel (e.g., TikTok)"
            />
        </div>
        ...
        <p style={{ fontSize: '14px', color: 'var(--color-secondary)', marginBottom: '15px' }}>
          Showing {sortedData.length} of {aggregatedData.length} channels. Aggregation completed in <span style={{ fontWeight: 600 }}>{aggregationTime} ms</span>.
        </p>
